...
router.on("/", async ()=>{
    ...
    const moduleMain = await require("41c6f9fed3a071b1");
    const mainPage = moduleMain.getMainPage();
    pageContainer.append(mainPage);
});
router.on("/catalog", async ()=>{
    pageContainer.innerHTML = "";
    const moduleCatalog = await require("2fed088220d12df3");
    const catalogPage = moduleCatalog.getCatalogPage();
    pageContainer.append(catalogPage);
});
router.on("/basket", async ()=>{
    pageContainer.innerHTML = "";
    const moduleBasket = await require("e24587c59e4f16a");
...
},{"./components/header.js":"iODzc","./components/pageContainer.js":"6pXtL","41c6f9fed3a071b1":"dsI8R","2fed088220d12df3":"adHFQ","e24587c59e4f16a":"9L8T0","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","navigo":"fuSlc","d772a986a2c25dfe":"33L2L"}],"iODzc":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
// Шапка
...
/* Контейнер для страниц */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
